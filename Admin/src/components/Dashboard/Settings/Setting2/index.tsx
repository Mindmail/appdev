...
const Setting2: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (musictypeState.length !== 0) {
      setSelectedType(musictypeState[0]);
  ...
  const handleSubmitType = async () => {
    ...
    if (editType.id !== 0) {
      await apiClientwithToken(localStorage.getItem("mindmail_admin_token"))
        .put("/admin/musictype/" + editType.id, editType)
        .then((res) => {
        ...
        <div className="sub-container">
          <div className="sub-body">
              ...
              <div className="sub-content">
                {musictypelist.map((item: any) => (
                  ...
                  >
                    <a
                      className={`${
                        selectedtype.id === item.id ? "selected" : ""
                      } title`}
                    >
                      {item.musictype}
                    </a>
            ...
            <div className="music-container">
              <div className="sub-header">
                <span>{selectedtype != null ? selectedtype.musictype : ""} / Music</span>
