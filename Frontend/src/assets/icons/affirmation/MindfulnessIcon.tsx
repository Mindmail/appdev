...
const MindfulnessIcon: React.FC<{
  fillColor?: string
  width?: number
  height?: number
}> = ({ fillColor = 'currentColor', width = 48, height = 48 }) => {
  return (
    <svg
    ...
    >
      ...
      >
        ...
        <path
          id="Icon_ionic-md-water"
          data-name="Icon ionic-md-water"
          ...
          transform="translate(96.371 233.294)"
          fill={fillColor}
        />
        <g
          id="Ellipse_7"
          data-name="Ellipse 7"
          transform="translate(97 232)"
          fill="none"
          stroke={fillColor}
          strokeWidth="0.4"
        >
